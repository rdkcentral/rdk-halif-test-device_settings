...
#### [6.0.1](https://github.com/rdkcentral/rdk-halif-test-device_settings/compare/6.0.0...6.0.1)

- PR: gh#490 : Fixing log flooding by removing strtok usage on string array [`#493`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/493)
- gh #522 Update HDMIIn L1 as per the new changes introduced in interface file [`#524`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/524)
- PR: gh #483 : Adding missing L1 test in yaml file [`#499`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/499)
- gh #521 dsDisplay L3 get aspect ratio update [`#523`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/523)
- updated Sink_4K_Display.yaml Sink_AudioSettings.yaml Sink_CompositeIn… [`#503`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/503)
- Deploy cla action [`#508`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/508)
- gh #470 Ignore level amount when volLeveller is off [`#471`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/471)
- Merge tag '6.0.0' to Develop [`#473`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/473)
- gh #521 updated the get aspect ration L3 testcase [`fc43c3d`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/fc43c3dcc039bdf50053cd4bc6335b28c551b769)
- gh #521 updated using the Videoport API's [`8fcda7e`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/8fcda7ea0693b1d3e669968587e7733979dc4e5f)
- gh #522 addressed review comments [`c76aa46`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/c76aa4640ec6cdd9fd57e143335a247bf73959f7)

### [6.0.0](https://github.com/rdkcentral/rdk-halif-test-device_settings/compare/5.1.0...6.0.0)

> 7 July 2025

- gh #445 update framerate yaml [`#458`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/458)
- PR:  gh #429 : Move port specific info to yaml [`#460`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/460)
- gh #434: expect dsERR_OPERATION_NOT_SUPPORTED based on device type [`#440`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/440)
- #gh451 removed sink dependency_VideoPort_L3 for verify HDCP version  … [`#466`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/466)
- updating dsHdmiIn, dsAudio L1 L2 test setup files with new and missing test cases [`#462`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/462)
- gh #417 dsAudio L3 pass a valid handle for certain port-independent APIs [`#419`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/419)
- gh #447 videoport l1 l2 tvapi revisit [`#450`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/450)
- gh #456 dsAudio: L1 test_l1_dsAudio_negative_dsGetAssociatedAudioMixing passing valid parameters for a invalid param check [`#457`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/457)
- gh #468 Test Document updation [`#469`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/469)
- gh #441 VRR latest update as per interface file [`#467`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/467)
- Revert "issue441 l3 dshdmi in vrr latestupdate" [`#463`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/463)
- Updated L1 of dsHdmiInGetVRRStatus [`#438`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/438)
- issue441 l3 dshdmi in vrr latestupdate [`#442`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/442)
- gh #422 Ensure all tests (L1/L2/L3) are available for MS12 features [`#444`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/444)
- Deploy cla action [`#449`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/449)
- merged 5.1.0 tag to develop [`#436`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/436)
- updating dsHdmiIn, dsAudio L1 L2 testsetup files with new and misisng tests cases [`a60b89d`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/a60b89d753e3fb50fd27dc999f4855559ab154c5)
- gh #422 updated L1_L2 based on new MS12 features [`192c788`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/192c788a856cb590c3ecaccbe5f14d06a9ca2585)
- Move : gh #429 : Move port specific info to yaml [`577a58d`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/577a58dd095793c786ce12849e08d119addf3f1c)

#### [5.1.0](https://github.com/rdkcentral/rdk-halif-test-device_settings/compare/5.0.1...5.1.0)

> 19 May 2025

- Release/5.1.0 [`#435`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/435)
- Revert "RDKEVD-1320: Expect dsERR_OPERATION_NOT_SUPPORTED on Source Devices" [`#430`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/430)
- RDKEVD-1320: Expect dsERR_OPERATION_NOT_SUPPORTED on Source Devices [`#421`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/421)
- gh #403 L1/L2 Tests for VRR [`#426`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/426)
- gh#424 replace dsAVICONTENT_TYPE_INVALID with dsAVICONTENT_TYPE_NOT_SIGNALLED in HDMI Input test [`#425`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/425)
- gh #427 Update test_l3_dsHdmiIn.c [`#428`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/428)
- gh #412 hdmiIn L3 python vrr changes [`#416`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/416)
- gh #407 L3 VRR C-test [`#418`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/418)
- Add l3 avi info frame apis on display [`#414`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/414)
- #394 l1 dsvideoport is display connected [`#409`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/409)
- gh #393 : Fix variable initialization in test cases [`#402`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/402)
- #gh 406 Fix hdmiport initialization [`#410`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/410)
- gh #343 move to L3 Allm Testcases to display [`#390`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/390)
- merged 5.0.1 tag to develop  [`#401`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/401)
- gh #412 VRR pyhton file changes [`710a661`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/710a6615a018a23b240a15cd6dc32320eb33759d)
- gh #343 addressed review comments [`87a14bd`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/87a14bdec4461e21036c6d27f6e45ea6af1cd1e7)
- gh #408 updated display [`2551596`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/25515969f6c18e3f92d2320c516d305114ba6c6a)

#### [5.0.1](https://github.com/rdkcentral/rdk-halif-test-device_settings/compare/5.0.0...5.0.1)

> 7 April 2025

- Release/5.0.1 [`#400`](https://github.com/rdkcentral/rdk-halif-test-device_settings/pull/400)
...
- Bumped CHANGELOG.md - 5.0.1 [`1f9dfc3`](https://github.com/rdkcentral/rdk-halif-test-device_settings/commit/1f9dfc372869862895974cd425f0755f5776eb74)
