...
class dsHdmiIn_L1_L2_tests(utHelperClass):
    """
    Test class to run the L1 and L2 tests on the device.

    This class uses the `dsHdmiInClass` to interact with the device
    ...
    def __init__(self, log:logModule=None):
        ...
        testSetupPath = os.path.join(dir_path, "dsHdmiIn_L1_L2_testSetup.yml")
    ...
    def testFunction(self):
        ...
        for testsuite in testsuites:
            ...
            testdsHdmiIn = dsHdmiInClass(self.moduleConfigProfileFile, self.hal_session, testsuite_name, self.targetWorkspace, copyArtifacts)
            copyArtifacts = False
