...
class dsAudio_L1_L2_tests(utHelperClass):
    """
    Test class to run the L1 and L2 tests on the device.

    This class uses the `dsAudioClass` to interact with the device
    ...
    def testFunction(self):
        ...
        for testsuite in testsuites:
            ...
            testdsAudio = dsAudioClass(self.moduleConfigProfileFile, self.hal_session, testsuite_name, self.targetWorkspace, copyArtifacts)
            copyArtifacts = False
