...
class dsHdmiIn_test12_GetSpdInfo_Verify(utHelperClass):

    testName  = "test12_GetSpdInfo_Verify"
    ...
    def CheckDeviceAndInfoStatus(self, manual = False, port_type:str=0, spd_info:str=0):
        """
        Verifies whether the Device Status and Spdinfo received on particular port.
    ...
    def testFunction(self):
        """
        The main test function tests Spd Info on port.

        This function:
        - Downloads necessary assets.
        - Runs prerequisite commands.
        - Verifies Spd Info through Manual Verification.
        ...
        self.log.testStart("test12_GetSpdInfo_Verify", '1')
