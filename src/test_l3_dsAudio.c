...
/**
* @brief This test retrieves and displays the supported application audio configurations.
*
* This test calls dsGetApplicationAudioConfigList() and prints each supported
* application audio configuration in menu format for the Python L3 helper.
*
* **Test Group ID:** 03@n
* **Test Case ID:** 021@n
*
...
/**
* @brief This test interactively gets audio configuration.
*
* This test retrieves the list of supported application audio configurations,
* then calls dsGetApplicationAudioConfig() for the selected configuration.
* **Test Group ID:** 03@n
* **Test Case ID:** 022@n
*
* **Test Procedure:**
...
* [dsAudio_L3_Low-Level_TestSpecification.md](../docs/pages/ds-audio_L3_Low-Level_TestSpecification.md)
*/
void test_l3_dsAudio_get_application_audio_config(void)
{
    gTestID = 22;
    UT_LOG_INFO("In %s [%02d%03d]", __FUNCTION__, gTestGroup, gTestID);
...
int32_t test_l3_dsAudio_register(void)
{
    ...
    UT_add_test(pSuite, "Get Application Audio Config", test_l3_dsAudio_get_application_audio_config);
