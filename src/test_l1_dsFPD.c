 ...
 * 
 * @todo loop through formate for positive and negative tests for these enums
 * 
 * **Test Group ID:** Basic: 01@n
 * **Test Case ID:** 19@n
 * 
 ...
 * 
 * @todo add case where we check for dsFPD_MODE_ANY works. Check all positive cases and negative
 * 
 * **Test Group ID:** Basic: 01@n
 * **Test Case ID:** 021@n
 * 
