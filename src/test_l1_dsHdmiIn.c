...
void test_l1_dsHdmiIn_negative_dsHdmiInGetNumberOfInputs(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInGetNumberOfInputs(NULL), dsERR_NONE);
    #endif
...
void test_l1_dsHdmiIn_negative_dsHdmiInGetStatus(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInGetStatus(&status), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInGetStatus(NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsHdmiInSelectZoomMode(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInSelectZoomMode(dsVIDEO_ZOOM_NONE), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInSelectZoomMode(dsVIDEO_ZOOM_MAX), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsHdmiInGetCurrentVideoMode(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInGetCurrentVideoMode(&resolution), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsHdmiInGetCurrentVideoMode(NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsIsHdmiARCPort(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsIsHdmiARCPort(dsHDMI_IN_PORT_0, NULL), dsERR_NONE);
    #endif
...
void test_l1_dsHdmiIn_negative_dsGetEDIDBytesInfo(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEDIDBytesInfo(dsHDMI_IN_PORT_0, edidBytes, &edidSize), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEDIDBytesInfo(dsHDMI_IN_PORT_MAX, edidBytes, &edidSize), dsERR_GENERAL);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEDIDBytesInfo(dsHDMI_IN_PORT_0, NULL, &edidSize), dsERR_GENERAL);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEDIDBytesInfo(dsHDMI_IN_PORT_0, edidBytes, NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsGetHDMISPDInfo(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsGetHDMISPDInfo(dsHDMI_IN_PORT_MAX, spdInfo1), dsERR_GENERAL);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetHDMISPDInfo(dsHDMI_IN_PORT_0, NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsSetEdidVersion(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsSetEdidVersion(dsHDMI_IN_PORT_MAX, HDMI_EDID_VER_14), dsERR_GENERAL);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsSetEdidVersion(dsHDMI_IN_PORT_0, HDMI_EDID_VER_MAX), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsGetEdidVersion(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEdidVersion(dsHDMI_IN_PORT_0, &edid_version), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEdidVersion(dsHDMI_IN_PORT_MAX, &edid_version), dsERR_GENERAL);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetEdidVersion(dsHDMI_IN_PORT_0, NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsGetAllmStatus(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsGetAllmStatus(dsHDMI_IN_PORT_0, &allm_status), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetAllmStatus(dsHDMI_IN_PORT_MAX, &allm_status), dsERR_GENERAL);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetAllmStatus(dsHDMI_IN_PORT_0, NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsGetSupportedGameFeaturesList(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsGetSupportedGameFeaturesList(&supported_features), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetSupportedGameFeaturesList(NULL), dsERR_GENERAL);
    #endif
...
void test_l1_dsHdmiIn_negative_dsGetAVLatency(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsGetAVLatency(&audioLatency, &videoLatency), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetAVLatency(NULL, &videoLatency), dsERR_NONE);
    #endif
    ...
    #else
    UT_ASSERT_EQUAL(dsGetAVLatency(&audioLatency, NULL), dsERR_NONE);
    #endif
...
void test_l1_dsHdmiIn_negative_dsSetEdid2AllmSupport(void) {
    ...
    #else
    UT_ASSERT_EQUAL(dsSetEdid2AllmSupport(dsHDMI_IN_PORT_MAX, true), dsERR_GENERAL);
    #endif
