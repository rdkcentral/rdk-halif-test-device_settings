...
int test_l1_dsHdmiIn_register ( void )
{
	...
	UT_add_test( pSuite, "dsGetEdid2AllmSupport_L1_positive" ,test_l1_dsHdmiIn_positive_dsGetEdid2AllmSupport );
	UT_add_test( pSuite, "dsGetEdid2AllmSupport_L1_negative" ,test_l1_dsHdmiIn_negative_dsGetEdid2AllmSupport );
