# dsCompositeIn HAL L1 and L2 Test Procedure
...
Example Test Setup configuration File: [dsCompositeIn_L1_L2_testSetup.yml](../../../host/tests/L1_L2_TestCases/dsCompositeIn/dsCompositeIn_L1_L2_testSetup.yml)
...
```yaml
dsCompositeIn:
  description: "dsCompositeIn Device Settings L1 and L2 test setup"
...
```bash
python dsCompositeIn_L1_L2_tests.py --config </PATH>/ut/host/tests/configs/example_rack_config.yml --deviceConfig </PATH>/ut/host/tests/configs/deviceConfig.yml
```
