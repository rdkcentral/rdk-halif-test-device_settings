...
|Description|L2|L3|HAL APIs|Source|Sink|
|-----------|--|--|--------|------|----|
|Test the 'Display connected' event. Upon connecting the display device, the callback should trigger the event|dsRegisterDisplayEventCallback,dsDisplayEventCallback_t|N|Y|Y|Y|
