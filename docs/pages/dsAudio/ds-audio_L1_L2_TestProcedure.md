# dsAudio HAL L1 and L2 Test Procedure
...
Example Test Setup configuration File: [dsAudio_L1_L2_testSetup.yml](https://github.com/rdkcentral/rdk-halif-test-device_settings/blob/main/host/tests/L1_L2_TestCases/dsAudio/dsAudio_L1_L2_testSetup.yml)
