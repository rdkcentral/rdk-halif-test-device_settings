# dsHost HAL L1 and L2 Test Procedure
...
deviceConfig:
    cpe1:
        ...
        test:
            profile: "../../../../profiles/source/Source_Host.yaml"
```

#### Test Setup Configuration File

Example Test Setup configuration File: [dsHost_L1_L2_testSetup.yml](../../../host/tests/L1_L2_TestCases/dsHost/dsHost_L1_L2_testSetup.yml)
...
dsHost:
  ...
  test_suites: # List of L1 and L2 test suites
    - name: "L1 dsHost" # Name of the test suit to run
...
```yaml
dsHost:
    description: "dsHost Device Settings testing profile / menu system for UT"
    test:
        artifacts:
...
```bash
python dsHost_L1_L2_tests.py --config </PATH>/ut/host/tests/configs/example_rack_config.yml --deviceConfig </PATH>/ut/host/tests/configs/deviceConfig.yml
```