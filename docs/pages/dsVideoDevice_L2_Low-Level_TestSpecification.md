# DSVIDEODEVICE L2 Low Level Test Specification and Procedure Documentation
...
|Description|Loop through each supported video device and get Video codec information for each video device and verify the with `Source_VideoDevice.yaml(VideoDevice/VideoDevice0/VideoCodecInfo)` profile file|
|Test Group|Module : 02|
|Test Case ID|006|
|Priority|High|
