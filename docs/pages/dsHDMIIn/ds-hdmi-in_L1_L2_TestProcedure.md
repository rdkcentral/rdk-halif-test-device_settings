...
Example Test Setup configuration File: [dsHdmiIn_L1_L2_testSetup.yml](../../../host/tests/L1_L2_TestCases/dsHdmiIn/dsHdmiIn_L1_L2_testSetup.yml)
...
Example Test Setup configuration File: [dsHdmiIn_testConfig.yml](../../../host/tests/dsClasses/dsHdmiIn_testConfig.yml)
